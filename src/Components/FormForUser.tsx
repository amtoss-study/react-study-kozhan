  ...
  return (
    ...
    >
      <input
        ...
        onChange={(event) =>
          setNewUserValues({ ...newUser, userName: event.target.value })
        }
      />
      <input
        placeholder="User Age Name"
        value={newUser?.userAge}
        onChange={(event) =>
          setNewUserValues({
            ...newUser,
            userAge: parseInt(event.target.value),
          })
        }
      />
      <input
        ...
        onChange={(event) =>
          setNewUserValues({ ...newUser, userPhone: event.target.value })
        }
      />
